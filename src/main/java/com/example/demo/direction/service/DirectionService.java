...
public class DirectionService {
    ...
    public String findDirectionUrlById(String encodedId) {
        Long docodedId = base62Service.decodeDirectionId(encodedId);
        Direction direction =  directionRepository.findById(docodedId).orElse(null);
    ...
    public List<Direction> buildDirectionListByCategoryApi(DocumentDto inputDocumentDto) {
        ...
        return kakaoCategorySearchService
                .requestPharmacyCategorySearch(inputDocumentDto.getLatitude(), inputDocumentDto.getLongitude(), RADIUS_KM * 1000)
                .getDocumentList()
